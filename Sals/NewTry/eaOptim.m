function [objective] = eaOptim(x,sourceCoordinates,targetCoordinates,adjMatrix,impossible,xind,yind)
...
objective = 10^8*(numInfeasible) + 10^12*(numImpossible-impossible);
